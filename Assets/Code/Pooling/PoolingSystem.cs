...
public class PoolingSystem<T> where T: class 
{
	...
	/// Initial size.
	/// </param>
	public PoolingSystem (GameObject prefab, int initialSize, Transform container, bool startInactive = true)
	{
		...
		for (int i = 0; i < initialSize; i++)
		{
			...
			if (temp==null)
			{
				//Debug.LogError("Failed to create the pooled gameobject");
				//Debug.Break();
			}
	...
	public T GetElement()
	{
		...
		{
			//Debug.LogWarning("Poolsize too small - create another by instantiation!");
			//Debug.Break();
		...
		{
			//Debug.LogError("something wrong in object pool");
		}
