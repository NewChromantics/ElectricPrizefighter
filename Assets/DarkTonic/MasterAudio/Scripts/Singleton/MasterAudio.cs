...
public class MasterAudio : MonoBehaviour {
    ...
    private const string HideLogoNavKey = "~MA_HideLogoNav~";
    ...
    public MixerWidthMode mixerWidth = MixerWidthMode.Normal;
    ...
    private static PlaySoundResult PlaySoundAtVolume(string sType,
        ...
        if (randomSource.Variation == null) { // scene ending
            return null;
        }
    ...
    public static bool HideLogoNav {
        ...
        set {
            PlayerPrefs.SetInt(HideLogoNavKey, value ? 1 : 0);
        }
    }
